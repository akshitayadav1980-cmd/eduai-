...
- [x] **Always lazy load** `@splinetool/react-spline`.
- [x] Use passive event listeners for scroll bindings.
- [x] Check for mobile screen widths and low-power devices.
- [x] Manage loading state with a spinner or skeleton overlay.
- [x] Keep heavy logic in React state and synchronize via `setVariable`.
