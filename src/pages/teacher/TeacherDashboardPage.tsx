...
import { TeacherSidebar, TeacherSectionId } from '../../components/dashboard/teacher/TeacherSidebar'
import { DashboardNav } from '../../components/dashboard/DashboardNav'
import { TeacherHomeSection } from '../../components/dashboard/teacher/TeacherHomeSection'
import { TeacherStudentsSection } from '../../components/dashboard/teacher/TeacherStudentsSection'
import { TeacherLessonsSection } from '../../components/dashboard/teacher/TeacherLessonsSection'
...
export function TeacherDashboardPage() {
  ...
  const [activeSection, setActiveSection] = useState<TeacherSectionId>('home')

  // Smooth scroll to section
  const handleScrollToSection = (sectionId: TeacherSectionId) => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      } else if (studentsEl && scrollPosition >= studentsEl.offsetTop) {
  ...
  const sectionTitles: Record<TeacherSectionId, string> = {
    home: 'HOME',
    students: 'STUDENTS',
    lessons: 'LESSONS',
  }
  ...
  return (
    ...
    >
        ...
        <div
          ...
          style={{
            background: isDarkMode
              ? 'radial-gradient(ellipse at center, rgba(139,92,246,0.05) 0%, rgba(6,182,212,0.03) 50%, transparent 80%)'
      ...
      >
        ...
        {/* ── Scrollable Teacher Learning Space Stream ── */}
        <main className="flex-1 px-4 sm:px-8 md:px-12 py-8 space-y-16">
          
          {/* Section 1: HOME */}
          <TeacherHomeSection
            onNavigateToStudents={() => handleScrollToSection('students')}
        ...
        >
          <p className="font-semibold text-xs text-inherit">Vernacular AI · Teacher Workspace</p>
